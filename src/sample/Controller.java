...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
       if (this.loginModel.isDatabaseConnection()) {
           this.dbStatus.setText("Conneted yo DB.");
       }else {
...
//                JOptionPane.showMessageDialog(null, "Welcome to MIT SATYAI APP");
//            } else {
...
//        }
        try {
            if (this.loginModel.isLogin(this.username.getText(),this.getText))
                JOptionPane.showMessageDialog(null,
                        "Welcome to MIT SATYAI APP");
        }else{
            JOptionPane.showMessageDialog(null,
